...
export class AppModelResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserAppAccess], { name: "userAppAccesses" })
  @nestAccessControl.UseRoles({
  ...
  async findUserAppAccesses(
    ...
    const results = await this.service.findUserAppAccesses(parent.id, args);
  ...
  @graphql.Query(() => AppModelUpdateInput)
  async FetchCookies(
    @graphql.Args()
    args: AppModelFindUniqueArgs
  ): Promise<AppModelUpdateInput> {
    return this.service.FetchCookies(args);
  }

  @graphql.Mutation(() => AppModelUpdateInput)
  async UpdateCookies(
    @graphql.Args()
    args: AppModelUpdateInput
  ): Promise<AppModelUpdateInput> {
    return this.service.UpdateCookies(args);
  }
}
